...
#    Updated: 2023/12/22 21:41:35 by ldufour          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
$(SRC_DIR)/utils.c $(SRC_DIR)/builtin/cd.c $(SRC_DIR)/builtin/builtin_execution.c $(SRC_DIR)/env_utils.c $(SRC_DIR)/command_execution.c $(SRC_DIR)/quote_handler.c $(SRC_DIR)/l_error.c\
